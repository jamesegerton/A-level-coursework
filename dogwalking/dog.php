...
<form action="adddog.php" method = "post">
  ...
  Can be walked off lead:<select name="onlead">
		<option value="Y">Yes</option>
		<option value="N">No</option>
	</select>
  <br>
  <!--Next 3 lines create a radio button which allows the user to select the dog size-->
  <input type="radio" name="role" value="big" checked> Big<br>
  <input type="radio" name="role" value="medium"> Medium<br>
  <input type="radio" name="role" value="small"> Small<br>
